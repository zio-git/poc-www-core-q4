...
recipients = ["+265998006237", "+265999971593", "+265999611280", "+265991450316", "+265995246144", "+265995316633", "+265999453942", "+265995971632", "+265995532195", "+265998276712", "+265992182669", "+265888771809", "+265994135772"]
    ...
    while(count < 3):
        ...
        if subprocess.call(['ping', param, '1', site['ip_address']]) == 0:
            ...
            for recipient in recipients:
                msg = "Hi there,\n\nDeployment of CORE for " + site['name'] + " completed succesfully.\n\nThanks!\nDevOps Team."
                params = {
                    "tenant_id": "12345",
                    "recipient": recipient,
                    "message": msg,
            ...
            if count == 3:
                for recipient in recipients:
                    msg = "Hi there,\n\nDeployment of CORE for " + site['name'] + " failed to complete after several connection attempts.\n\nThanks!\nDevOps Team."
                    params = {
                        "tenant_id": "12345",
                        "recipient": recipient,
                        "message": msg,
