  ...
  stages {
    ...
    stage('Fetching ART') {
      steps {
        ...
        sh '[ -d "BHT-Core/apps/ART" ] && echo "ART already cloned." || mkdir apps; cd $WORKSPACE/BHT-Core/apps; mkdir ART; cd $WORKSPACE/BHT-Core/apps/ART; git clone https://github.com/HISMalawi/BHT-Core-Apps-ART.git .'
